...
Route::post('/home/cart', [CartController::class, 'orderCart'])->name('home.cart.order');
Route::get('/home/cart/{id}', [CartController::class, 'addCart'])->name('home.cart.addcart');
Route::get('/home/cart/quantity/{id}&{type}', [CartController::class, 'updateCart'])->name('home.cart.updatecart');
